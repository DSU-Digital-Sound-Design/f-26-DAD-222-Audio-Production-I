...
- If you want just one layer of a capture, like the drums without the bass or a vocal phrase on its own, run it through [Ultimate Vocal Remover](https://github.com/Anjok07/ultimatevocalremovergui). It's free, it runs on your own machine, and it separates a mix into stems. Results vary with the source material, so audition what comes out. Mention the tool in your submission notes, the same way you name your sample sources (see the AI tools section of the [syllabus](/syllabus/)).
- Use the production techniques we've covered in class, such as EQ, compression, reverb, and delay, to enhance your project.
- Set up at least **one send** for your reverb or delay, the way you did in Project 3, and route **two or more tracks** to it so they share the same space. EQ and compression stay as inserts. If the routing steps are fuzzy, review the [rough balance lesson](/lectures/week-6/rough-balance/).
...
| ---------------------- | ---------- | ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Excellent**          | 41-45      | A (90-100)       | The composition is highly original and well-produced. Track selection, arrangement, MIDI sequencing, sample usage, and production techniques (EQ, compression, and reverb or delay on a shared send) are of exceptional quality, resulting in a polished final mix. |
