---
title: "Ear Training Drills"
summary: "Ten-minute listening drills that open class through the second half of the semester. Each one tests a single thing you've already learned, by ear alone."
tags: [ear training, critical listening]
---

Engineers are hired for their ears, and they develop them through
short, repeated practice. Starting in week 6, we'll open one class each week with
a ten-minute drill. I'll change one thing about a sound, you decide what changed,
and you commit your answer on paper before anyone discusses it. Then I'll reveal
the answer and we'll listen again. 
...
I'll boost one octave band by 12 dB with ReaEQ, first on pink noise and then on a
...
software, and most of you will take it. 
...
3. I'll reveal the answer, and we'll listen one more time. That final listen, when you know what to hear, is where the learning happens.
{{< /drill >}}

## 10/16: Compression

We'll run three rounds on a drum loop, and each round asks a harder question.
First you decide whether the loop is compressed at all. Then you'll compare
...
Two rounds built on sends you can't see. First you decide whether the effect
on the vocal is a reverb or a delay. Then you judge the size of the space by
how long the tail hangs on: a small room or a large hall. We'll finish with a
wet and dry comparison, where you pick which of two passes carries more of
the effect.

## 10/26: Balance and image

I'll play a short mix twice, and between the passes one element changes. It
moves 3 dB up or down, or it moves to a new spot in the stereo field. You
name the element and describe the move. In the last round I'll collapse the mix
to mono, and you tell me what vanished.

## 11/2: One hidden difference

You'll hear two versions of the same mix section, matched in loudness. One of
...
- Majors: MUS 109 goes much deeper on frequency training.
